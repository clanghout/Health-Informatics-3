...
/**
 * This class sorts a DataTable on whatever column you want it to sort on, but REVERSED.
 * 
...
public class ReversedSortProcess extends DataProcess {
	...
	public Table doProcess() {
		DataTable sortedTable = new SortProcess(table,column).doProcess().getTable(table.getName());
